...
///
/// Provider 的基本使用
class TestCount03Page extends StatefulWidget {
  @override
  _TestCount03PageState createState() => _TestCount03PageState();
}

class _TestCount03PageState extends State<TestCount03Page> {
  @override
      ...
      body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 40,),
              Text("CountModel02 显示计数 ${context.watch<CountModel02>().count}"),
            ],
          )),
